<?php
// database/reset_complete.php
// PERBAIKAN C3 & H2: tambahkan proteksi sesi sebelum operasi destruktif apapun
session_start();
...
// Tambahan: hanya super_admin yang boleh melakukan reset
...
<body class="bg-blue-50 p-8">
    <div class="max-w-2xl mx-auto bg-white p-8 rounded-xl shadow-lg">
        ...
        <?php if ($status === "success"): ?>
            ...
            <script>setTimeout(() => { window.location = '/database/setup.php'; }, 3000);</script>
        <?php else: ?>
